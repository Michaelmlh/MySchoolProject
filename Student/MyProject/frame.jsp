    ...
    <% 权限 user=((权限)session.getAttribute("user"));%>
        <div class="body">
            <div class="mytop">
                <div class="top">
                    <div class="logo">
                        <img alt="LOGO" src="images/LOGO.PNG" width="80" height="40" />
                    </div>
                    <div class="title">
                    ...
                    <ul class="function">
                        <li>
                            <a href="StuInfo" target="main">用户信息</a>
                            <!-- 同个人详情 -->
                        </li>
                        <%if(user!=null){ //登录后操作%>
                            <li>
                ...
                <div class="top">
                    <%if(user!=null){ %>
                        ...
                        <%}else{%>
                            <span>
                                <a href="Login&Register/login.jsp">登录</a>
                            </span>
                            <%} %>
                </div>
            ...
            <div class="left">
                <span style="width: 120px;">操作选择菜单：</span>
                <br>
                <%if(user!=null){ //登录后操作%>
                    <div id="option1">
                        <ul class="nav">

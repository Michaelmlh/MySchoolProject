			...
			<ul class="navbar-nav nav navbar-collapse collapse mycollapse" id="">
				...
				<li role="presentation" class="dropdown"><a href="#"
					...
					<ul class="dropdown-menu">
						<li><a href="StuInfo" target="main">个人详情</a></li>
						<li><a href="1Query/bulkQuery.html" target="main">批量查询</a></li>
				...
				<li role="presentation" class="dropdown"><a href="#"
					...
					<ul class="dropdown-menu">
						<li><a href="2Control/students/student.jsp" target="main">学生管理</a>
						</li>
						<li><a href="2Control/classes/class.jsp" target="main">班级管理</a>
						</li>
						<li><a href="2Control/rooms/room.jsp" target="main">宿舍管理</a>
						</li>
						<li><a href="2Control/environments/environment.jsp"
							target="main">卫生管理</a></li>
						<%
							if (user.canDo(1)) {//仅系统管理员可查看
						%>
						<li><a href="2Control/levels/level.jsp" target="main">权限管理</a>
						</li>
					</ul></li>
				<%
					}
